function [rating, RT] = sliderRating_forNIMADET_MEG(w, questionText, screenXpixels, screenYpixels, RM, orientation, rect, V, lowerBoundText, upperBoundText)
...
while ~confirmed && (GetSecs - tStart) < respWindow
    ...
    DrawFormattedText(w, 'Press [RM] to confirm!', (screenXpixels*0.5) - 120, (screenYpixels* 0.75)-20, 255);
