...
function [V,acc] = StaircasePilot(subID,orientation,gratingName,V,~,config, volume, deviceToUse)
...
text = ['Now we will do the same thing with Grating B! \n ',...
    'The procedure will exactly be the same as Grating A. \n',...
    'The only difference is the order of the response keys have changed. \n',...
    '[j] will be the No key and [k] will be the Yes key throughout this phase. \n',...
